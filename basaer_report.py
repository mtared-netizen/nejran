...
def page_org_overview(c, pg):
    ...
    objectives = [
        ...
        ("الهدف الرابع",
         "تيسير مشاريع الخير والعمل الخيري في مجالات التخصص المتعلقة بأهداف الجمعية."),
    ]
    cy = y5 - 8*mm
...
def page_swot(c, pg):
    ...
    quadrants = [
        (DKGREEN, "نقاط القوة (Strengths) — 14 نقطة", [
            ...
            "ثقة العلماء والمشايخ: 168 كلمة دعوية، 46 درساً في 2025",
...
def page_programs_objectives(c, pg):
    ...
    programs = [
        ...
        ("برنامج متون (تحفيظ المتون العلمية)",
         ...
         "يخدم الهدف الثاني (الإرشاد الديني للمسلمين) والرابع (مشاريع الخير)"),
        ("مشروع تفطير الصائمين",
         False, False, False, True,
         "يندرج ضمن الهدف الرابع (العمل الخيري) — لا علاقة مباشرة بالجاليات"),
        ("الكلمات والمحاضرات الدعوية",
         True, True, False, False,
         "يخدم الهدفين الأول والثاني — دعوة الجاليات وإرشاد المسلمين"),
        ("المسابقة الرمضانية الإلكترونية",
         False, True, False, True,
         "إرشاد ديني للمسلمين — لا يستهدف الجاليات مباشرة"),
        ("برامج الجاليات الميدانية",
         True, False, True, False,
         "مباشر للهدف الأول والثالث — الأقل نشاطاً ميدانياً"),
        ("المجالس والدروس العلمية",
         False, True, False, False,
         "إرشاد ديني للمسلمين — لا يستهدف الجاليات"),
        ("توزيع المصاحف والمواد الدعوية",
         True, False, True, True,
         "يخدم أهداف الجاليات والتعليم والخير"),
        ("برنامج يوم في الحرم",
         False, False, True, True,
         "تأهيل المسلمين الجدد والعمل الخيري"),
        ("مشروع المصليات المتنقلة",
         False, True, False, True,
         "إرشاد ديني وعمل خيري — للمرابطين في الحد الجنوبي"),
        ("السلال الغذائية والتمور",
         False, False, False, True,
         "عمل خيري بحت — لا علاقة مباشرة بمحاور الدعوة"),
    ]
    ...
    findings = [
        ...
        ("الهدف الثاني — الإرشاد للمسلمين:",
         "يُمثّل الغالبية العظمى من أنشطة الجمعية (متون، دروس، محاضرات) — تضخّم على حساب الجاليات."),
        ("الهدف الثالث — تعليم المسلمين الجدد:",
         "ضعيف الحضور رغم أن الجمعية أسلمت 931 شخصاً — برامج التأهيل لا ترقى للمستوى المطلوب."),
        ("الهدف الرابع — العمل الخيري:",
         "حاضر بقوة في مشاريع التفطير والسلال — لكن بعضها لا يندرج مباشرة في تخصص الجمعية الدعوي."),
    ]
    cy2 = ty - 10*mm
