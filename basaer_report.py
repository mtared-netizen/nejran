...
def page_mafateeh_sharurah(c, pg):
    ...
    rect(c, MARGIN, H-126*mm, CW, 10*mm, fill=DKGREEN)
    txt(c, "إجمالي المستفيدين في شرورة 1444هـ: أكثر من 33,000 مستفيد ومستفيدة",
        W-MARGIN-5, H-119*mm, "Cairo-Bold", 9.5, WHITE, "right")
    txt(c, "العائد الاقتصادي للتطوع: 35,200 ريال  |  عدد المتطوعين: 26 متطوعًا",
        W-MARGIN-5, H-124*mm, "Cairo-Regular", 8, GOLD, "right")
    ...
    analysis_box(c, MARGIN, H-129*mm, CW, analysis_txt, "التحليل التشخيصي")
