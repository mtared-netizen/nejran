...
def page_programs_objectives(c, pg):
    ...
    # Alignment summary
    ty -= 4*mm
    rect(c, MARGIN, ty-50*mm, CW, 50*mm, fill=NAVY)
    txt(c, "خلاصة تحليل مدى توافق البرامج مع الأهداف", W-MARGIN-4, ty-4*mm,
        "Cairo-Bold", 10, GOLD, "right")
    findings = [
        ("الهدف الأول — الدعوة للجاليات:",
         "يُجسَّد في برامج الجاليات الميدانية والكلمات الدعوية فقط — الأقل حضوراً رغم أنه "
         "الغرض التأسيسي والمحور الأول في الاسم الرسمي للجمعية."),
        ("الهدف الثاني — الإرشاد للمسلمين:",
         "يُمثّل الغالبية العظمى من الأنشطة (متون، دروس، محاضرات، مسابقة) — تضخّم "
         "استراتيجي غير مُعلن على حساب هدف الجاليات التأسيسي."),
        ("الهدف الثالث — تعليم المسلمين الجدد:",
         "ضعيف الحضور رغم 931 مُسلَماً — برامج التأهيل لا ترقى للاحتياج وتفتقر للمنهجية."),
        ("الهدف الرابع — استخدام التقنية:",
         "يُجسَّده متون والمسابقة الإلكترونية فحسب — معظم البرامج ميدانية تقليدية."),
    ]
    cy2 = ty - 10*mm
    for title_f, desc_f in findings:
        txt(c, title_f, W-MARGIN-4, cy2, "Cairo-SemiBold", 8.5, GOLD, "right")
        txt(c, desc_f,  W-MARGIN-4, cy2-5*mm, "Cairo-Regular", 8, WHITE, "right")
        cy2 -= 9*mm
    # Critical finding — charitable burden
    rect(c, MARGIN+2, ty-47*mm, CW-4, 8*mm, fill=RED)
    wrap_ar(c,
